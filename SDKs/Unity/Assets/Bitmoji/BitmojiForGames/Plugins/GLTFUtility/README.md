...
[![GitHub issues](https://img.shields.io/github/issues/Bitmoji/GLTFUtility.svg)](https://github.com/Bitmoji/GLTFUtility/issues)
[![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://raw.githubusercontent.com/Bitmoji/GLTFUtility/master/LICENSE.md)
...
1. `"com.bitmoji.gltfutility": "https://github.com/Bitmoji/GLTFUtility.git"`
</details>
...
2. Clone GLTFUtility by itself or as a submodule
    * Clone into your assets folder `git clone git@github.com:Bitmoji/GLTFUtility.git`
    * Add repo as submodule `git submodule add git@github.com:Bitmoji/GLTFUtility.git Assets/Submodules/GLTFUtility`
</details>
